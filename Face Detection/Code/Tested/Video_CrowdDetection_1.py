...
# frame = cv2.imread('C:/Users/User/Documents/Life/GTB/Tech Academy/Hackathon/Face Detection/frames/Datasetframe10.jpg')
while True:
    ...
    cv2.rectangle(frame, ((0,frame.shape[0] -25)),(800, frame.shape[0]), (255,255,255), -1)
